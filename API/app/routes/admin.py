...
def get_pending_users():
    ...
    try:
        ...
        users_data = [{
            ...
            "email": u.email,
            "role": u.role.name,
            "registered_at": format_datetime(u.created_at)  # Changed
        } for u in pending]
...
def get_all_teachers():
    ...
    try:
        ...
        teachers_data = [{
            ...
            "created_at": format_datetime(u.created_at).isoformat() if u.created_at else None  # Added
        } for u in teachers]
...
def get_all_results():
    ...
    try:
        ...
        results_data = [{
            ...
            "evaluated_at": format_datetime(ev.evaluated_at).isoformat() if ev.evaluated_at else None
